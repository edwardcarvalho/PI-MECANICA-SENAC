...
public class FormExcluirCliente extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FormExcluirCliente frame = new FormExcluirCliente();
	...
	public FormExcluirCliente() {
		...
		lblMtodoDePesquisa.setBounds(34, 90, 133, 14);
		...
		lblMostraDadosExcluir.setBounds(35, 148, 46, 14);
		...
		txtMostraDadosExcluir.setBounds(81, 147, 319, 20);
		...
		lblMostraDadosExcluir_2.setBounds(37, 186, 46, 14);
		...
		txtMostraDadosExcluir_2.setBounds(81, 185, 132, 20);
		...
		btnExcluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(option == 0){
					FormExcluirCliente.this.setVisible(false);
				}else{
		...
		comboBoxPesquisa.setBounds(35, 109, 114, 20);
